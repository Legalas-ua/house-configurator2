...
export const uk = {
  ...
  steps: {
    ...
    windows: {
      ...
      editor: {
        add: 'Додати вікно',
        addTo: (room: string) => `Додати у: ${room}`,
        noRoom: 'Усі приміщення поверху вже мають вікна',
        hint: 'Вікно можна поставити лише на зовнішній стіні — на межі двох приміщень його не буде',
